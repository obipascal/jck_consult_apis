...
class UsersApis extends Controller
{
	...
	public function verify(Request $request)
	{
		try {
			...
			$validator = Validator::make($request->only(["otp_code"]), [
				"otp_code" => ["bail", "numeric", "required", "unique:o_t_ps,otp_code"],
			]);
	...
	public function show(string $id)
	{
		try {
			...
			/* Call the controller handlers to handle request logic */
			$handler = Handlers::Users(request())->fetchUser($id);
		...
		try {
			...
			$validator = Validator::make(
				...
				[
					...
					"gender" => ["bail", "string", "required", Rule::in(["male", "female", "others"])],
					"qualification" => ["bail", "string", "required", Rule::in(["undergraduate", "graduate", "postgraduate"])],
					"password" => [
						"bail",
						"string",
						"required",
